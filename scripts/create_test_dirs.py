...
def main():
    ...
    TARGET_BASE_DIR = "/Users/luisbarajas/Documents/GitHub/ML-enabled-SCFT/scripts/results/experiment_batches"  # Target base directory path
    ...
    CSV_PATH = "/Users/luisbarajas/Documents/GitHub/ML-enabled-SCFT/scripts/results/predicted_L.csv"  # CSV with 'key' column (formulations)
    PHASE = "HEXPhase"  # Phase directory name (e.g., HEXPhase)
    N_BATCHES = 5       # Number of batches to split formulations into for the target structu
